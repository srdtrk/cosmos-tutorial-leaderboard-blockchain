...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/srdtrk/leaderboard/leaderboard/board
   */
  queryBoard = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetBoardResponse, RpcStatus>({
      path: `/srdtrk/leaderboard/leaderboard/board`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/srdtrk/leaderboard/leaderboard/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<LeaderboardQueryParamsResponse, RpcStatus>({
      path: `/srdtrk/leaderboard/leaderboard/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/srdtrk/leaderboard/leaderboard/player_info
   */
  queryPlayerInfoAll = (
    query?: {
    ...
    this.request<LeaderboardQueryAllPlayerInfoResponse, RpcStatus>({
      path: `/srdtrk/leaderboard/leaderboard/player_info`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/srdtrk/leaderboard/leaderboard/player_info/{index}
   */
  queryPlayerInfo = (index: string, params: RequestParams = {}) =>
    this.request<LeaderboardQueryGetPlayerInfoResponse, RpcStatus>({
      path: `/srdtrk/leaderboard/leaderboard/player_info/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
